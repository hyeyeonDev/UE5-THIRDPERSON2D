...
void AMyPaperCharacter::BeginPlay()
{
    ...
    FlipbookManager = NewObject<UCharacterFlipbookManager>();
    FlipbookManager->Initialize();

    UMyGameInstance* GameInstance = Cast<UMyGameInstance>(GetGameInstance());
    if (GameInstance)
    {
        GameInstance->InitializeCharacterStats(this, FName("Default"));
    }
...
void AMyPaperCharacter::SetStats(const FCharacterStatsData& NewStats)
{
    CurrentStats = NewStats;
    // 여기에서 캐릭터의 다른 속성들을 업데이트할 수 있습니다.
}